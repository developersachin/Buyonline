package com.beliefitsolution.buyonline.home;
...
import com.beliefitsolution.buyonline.fcm.Config;
import com.beliefitsolution.buyonline.fcm.NotificationUtils;
import com.beliefitsolution.buyonline.login.SigninActivity;
import com.beliefitsolution.buyonline.myaccount.myaccount;
import com.beliefitsolution.buyonline.wishlist.WishlistDetails;
        ...
        mRegistrationBroadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (intent.getAction().equals(Config.REGISTRATION_COMPLETE)) {
                    ...
                    //dialog popup for fcm msg in foreground
                    AppUtilits.displayMessageforFCM(HomeActivity.this, title, message, imgurl);
                }
            }
        };
