package com.beliefitsolution.buyonline.productpreview;
...
import com.beliefitsolution.buyonline.home.BestSelling_Adapter;
import com.beliefitsolution.buyonline.home.BestSelling_Model;
...
*/
    ...
    public void addtocartapi() {
        ...
        if (!NetworkUtility.isNetworkConnected(ProductDetails.this)) {
            ...
            if ((SharePreferenceUtils.getInstance().getString(Constant.USER_DATA)).isEmpty()) {
                AppUtilits.displayMessagetologin(ProductDetails.this, "Hello Guest User, Signin is required to use this feature");
